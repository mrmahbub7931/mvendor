<div class="page-main-header">
    <div class="main-header-right row">
        <div class="main-header-left d-lg-none">
            <div class="logo-wrapper"><a href="{{route('backend.dashboard')}}"><img class="blur-up lazyloaded" src="{{asset('assets/back-end/images/dashboard/multikart-logo.png')}}" alt=""></a></div>
        </div>
