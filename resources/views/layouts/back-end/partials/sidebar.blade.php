<div class="page-sidebar">
    <div class="main-header-left d-none d-lg-block">
        <div class="logo-wrapper"><a href="index-2.html"><img class="blur-up lazyloaded" src="{{asset('assets/back-end/images/dashboard/multikart-logo.png')}}" alt=""></a></div>
    </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li><a class="sidebar-header" href="#"><i data-feather="box"></i> <span>Products</span><i class="fa fa-angle-right pull-right"></i></a>
                <ul class="sidebar-submenu">
                    <li><a href="{{route('backend.category.index')}}"><i class="fa fa-circle"></i>Category</a></li>
...
<li><a class="sidebar-header" href="invoice.html"><i data-feather="archive"></i><span>Invoice</span></a>
            ...
            <li><a class="sidebar-header" href="{{ route('logout') }}"
