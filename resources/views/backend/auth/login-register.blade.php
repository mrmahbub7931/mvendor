                    ...
                    <div class="card tab2-card">
                        <div class="card-body">
                            <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                <li class="nav-item">
                                <a class="nav-link {{ \Request::is('login') ? 'active' : '' }}" id="top-profile-tab" data-toggle="tab" href="#top-profile" role="tab" aria-controls="top-profile" aria-selected="true"><span class="icon-user mr-2"></span>Login</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ \Request::is('register') ? 'active' : '' }}" id="contact-top-tab" data-toggle="tab" href="#top-contact" role="tab" aria-controls="top-contact" aria-selected="false"><span class="icon-unlock mr-2"></span>Register</a>
                                </li>
                            </ul>
                            <div class="tab-content" id="top-tabContent">
                                <div class="tab-pane fade  {{ \Request::is('login') ? 'show active' : '' }}" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                <form class="form-horizontal auth-form" method="post" action="{{route('login')}}">
                                        @csrf
                                        <div class="form-group">
                                            <input required="" name="login" type="text" class="form-control {{ $errors->has('number') || $errors->has('email') ? ' is-invalid' : '' }}" placeholder="Phone number or Email Address" id="login">
                                            @if ($errors->has('number') || $errors->has('email'))
                                                <span class="invalid-feedback">
                                                    <strong>{{ $errors->first('number') ?: $errors->first('email') }}</strong>
                                                </span>
                                            @endif
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-terms">
                                            <div class="custom-control custom-checkbox mr-sm-2">
                                                <input type="checkbox" class="custom-control-input" name="remeberme" id="remeberme">
                                ...
                                <div class="tab-pane fade {{ \Request::is('register') ? 'show active' : '' }}" id="top-contact" role="tabpanel" aria-labelledby="contact-top-tab">
                                <form class="form-horizontal auth-form" method="post" action="{{route('register')}}">
                                        @csrf
                                        <div class="form-group">
                                            <input name="name" type="text" class="form-control" placeholder="Full name" id="name">
                                        </div>
                                        
                                        <div class="form-group">
                                            <input name="number" type="text" class="form-control" placeholder="Phone number" id="number">
                                        </div>
